...
BASE="\/mnt\/storage\/blatti\/apps\/P1_source_check\/"   # change users to storage for cluster
CMD="sh -c 'cd /code/; /usr/bin/time -v python3 SRC.py;'" 
IMG="cblatti3\/python3:0.1"
ctr=1
CURL="curl -i -L -H 'Content-Type: application/json' -X POST -d@/shared/jobs/NUM_SRC.json mmaster02.cse.illinois.edu:4400/scheduler/iso8601"
